...
const USOPIPE = (() => {
  ...
  /* Коды площадок, планирующих ТОРО. 7101-7104 — сервисные площадки
     АО «Развитие» (в выгрузке они подписаны «АО "Развитие" Еруда\\…»,
     «АО «Развитие» Иркутск», «Алдан», «Магадан»), 2400 — ООО «Полюс
     Сухой Лог». Заказ ведёт сервисная площадка, а техника числится за
     добывающим активом, поэтому для фильтра площадки код сворачивается
     к активу (siteRegion). */
  const SITE_LABELS = {
    "1100": "Красноярск / Еруда", "1200": "Вернинское / Сухой Лог", "1300": "Алдан", "1400": "Магадан",
    "2400": "Полюс Сухой Лог",
    "7101": "Развитие Красноярск", "7102": "Развитие Иркутск", "7103": "Развитие Алдан", "7104": "Развитие Магадан"
  };
  const SITE_REGION = { "7101": "1100", "7102": "1200", "7103": "1300", "7104": "1400", "2400": "1200" };
  ...
  return { FMT, SITE_LABELS, SITE_REGION, createProcessor, unpack, pack, enrich, mergeIntoData, yearTotals };
})();
